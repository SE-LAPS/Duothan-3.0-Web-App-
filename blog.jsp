...
<body>
        ...
        <div class="col-lg-4">
          <div class="sidebar">
            ...
            <div class="sidebar-block">
              ...
              <div class="blog-item">
                ...
                <div class="content">
                  ...
                  <div class="meta">
                    <a href="#"><span class="mai-calendar"></span> January 12, 2023</a>
              ...
              <div class="blog-item">
                ...
                <div class="content">
                  <h5 class="post-title"><a href="#">Even the all-powerful Pointing has no control</a></h5>
                  <div class="meta">
                    <a href="#"><span class="mai-calendar"></span> February 12, 2023</a>
                    <a href="#"><span class="mai-person"></span> Admin</a>
                    <a href="#"><span class="mai-chatbubbles"></span> 19</a>
                  </div>
                </div>
            ...
            <div class="sidebar-block">
              ...
              <p>Medicines are chemicals or compounds used to cure, halt, or prevent disease; ease symptoms; 
                or help in the diagnosis of illnesses. Advances in medicines have enabled doctors to cure many diseases and save lives.
                Medi Pills is one of the 1st branded retail Pharmaceutical Chains website in Sri Lanka 
                that has entered the market with a view of creating a difference in the retail pharmaceutical trade.</p>
            </div>
          </div>
        </div> 
      </div> <!-- .row -->
  ...
  <footer class="page-footer">
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          ...
          <ul class="footer-menu">
            ...
            <li><a href="#">Doctors & Pharmacies</a></li>
          </ul>
        </div>
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Our partner</h5>
          <ul class="footer-menu">
            ...
            <li><a href="#">Asiri Hospitals</a></li>
            <li><a href="#">Suawasewana Hospitals</a></li>
          </ul>
        </div>
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Contact</h5>
          <p class="footer-link mt-2">Colombo Rd, Homagama, Sri Lanka</p>
          <a href="#" class="footer-link">+94-2233557</a>
          <a href="#" class="footer-link">MediPills</a>
      ...
      <p id="copyright">Copyright &copy; 2023 <a href="https://www.youtube.com/@CodeShowLapZ" target="_blank">Ceylon Coders</a>. All right reserved</p>
    </div> <!-- .container -->
  </footer> <!-- .page-footer -->
